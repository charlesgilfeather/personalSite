/*
 ...
 91.61 GUI Programming I Assignment 8:
...
function myFunction() {
    ...
    // round
    valX1 = parseInt(valX1, 10);
    valX2 = parseInt(valX2, 10);
    valY1 = parseInt(valY1, 10);
    valY2 = parseInt(valY2, 10);
    ...
    if(!boolx && !booly){
      ...
      document.getElementById("graph").appendChild(tab);
